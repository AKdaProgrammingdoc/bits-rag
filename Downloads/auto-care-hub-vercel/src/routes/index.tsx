...
import {
  ...
  Facebook, Instagram, Youtube, QrCode, Users, Gift, Sparkles,
...
import eventJungle from "@/assets/event-jungle.png";
import eventDesert from "@/assets/event-desert.png";
...
function Home() {
  ...
  const carServices = [
    { icon: Wrench, name: "General Service", desc: "Full general servicing, oil changes, tune-ups and diagnostics for all car brands." },
    { icon: Droplets, name: "Water Wash at Doorstep", desc: "Doorstep car water wash starting at ₹350 — full body foam wash, under chassis cleaning, interior vacuum, polish, tyre dressing & engine cleaning." },
  ];

  const bikeServices = [
    { icon: Wrench, name: "General Service", desc: "Complete general servicing, oil changes, brake service and tune-ups for all bikes & scooters." },
    ...
    { icon: AlertTriangle, name: "Breakdown Service", desc: "On-the-spot breakdown assistance and roadside support across Madurai — call us anytime." },
    { icon: Settings2, name: "Annual Maintenance", desc: "Yearly maintenance plans to keep your bike running like new — all brands covered." },
    { icon: Cog, name: "Engine Works", desc: "Expert engine diagnosis, overhaul and rebuilds by our multi-brand master technicians." },
    ...
    { icon: Truck, name: "Pickup & Drop / Spare Bike", desc: "Free pickup & drop and a spare bike while yours is being serviced." },
    { icon: PaintBucket, name: "Denting & Painting", desc: "Professional dent removal, body repair and high-quality paint finish for all bikes." },
    { icon: SprayCan, name: "Water Wash & Lubes", desc: "Thorough water wash plus premium engine oils and lubricants from trusted brands." },
  ];
    ...
    <div id="home" className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <Reveal delay={100}>
              <h1 className="mt-3 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-[1.05] uppercase break-words">
            ...
            <Reveal delay={400}>
              <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <div key={i} className="stat-cube rounded-xl p-3 text-center min-w-0">
                    <div className="text-lg sm:text-xl md:text-2xl font-display font-bold text-primary break-words leading-tight">
                      {stat.noNum ? stat.s : <><Counter to={stat.v} />{stat.s}</>}
                    </div>
                    <div className="text-[10px] sm:text-[11px] uppercase tracking-wider text-muted-foreground mt-1 break-words">{stat.l}</div>
                  </div>
                ))}
              </div>
            </Reveal>
      ...
      <section id="services" className="relative py-20 md:py-28 bg-surface/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {/* CAR SERVICES */}
          <Reveal>
            <div className="relative rounded-3xl overflow-hidden border border-primary/30 mb-12 shadow-elevated">
              <div className="absolute inset-0">
                <img src={carWashPoster} alt="SK Motors car wash starting at ₹350" className="w-full h-full object-cover opacity-25" />
                <div className="absolute inset-0 bg-gradient-to-br from-background/85 via-background/75 to-background/90" />
              </div>
              <div className="relative p-6 md:p-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 rounded-xl bg-primary/20 grid place-items-center text-primary"><Car size={24} /></div>
                  <div>
                    <div className="text-xs uppercase tracking-widest text-primary font-bold">Category 1</div>
                    <h3 className="text-2xl md:text-3xl font-display font-bold uppercase">Car Services</h3>
                  </div>
                </div>
          ...
          <Reveal>
            <div className="relative rounded-3xl overflow-hidden border border-primary/30 shadow-elevated">
              <div className="absolute inset-0">
                <img src={bikeServicesPoster} alt="SK Motors multi brand bike service centre" className="w-full h-full object-cover opacity-20" />
                <div className="absolute inset-0 bg-gradient-to-br from-background/90 via-background/80 to-background/95" />
              </div>
              <div className="relative p-6 md:p-10">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-12 h-12 rounded-xl bg-primary/20 grid place-items-center text-primary"><Bike size={24} /></div>
                  <div>
                    <div className="text-xs uppercase tracking-widest text-primary font-bold">Category 2</div>
                    <h3 className="text-2xl md:text-3xl font-display font-bold uppercase">Bike Services</h3>
                  </div>
                </div>
      ...
      {/* SPECIAL OFFER — SPARE BIKES */}
      <section className="relative py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0 opacity-50" style={{ background: "var(--gradient-radial-glow)" }} />
        <Embers count={20} />
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6">
          <Reveal>
            <div className="relative rounded-3xl border-2 border-primary bg-gradient-to-br from-primary/15 via-surface to-surface-elevated p-8 md:p-12 shadow-glow overflow-hidden">
              <div className="absolute -top-20 -right-20 w-72 h-72 rounded-full bg-primary/30 blur-3xl animate-pulse-glow" />
              <div className="absolute -bottom-20 -left-20 w-72 h-72 rounded-full bg-primary-glow/20 blur-3xl" />
              <div className="relative">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary text-primary-foreground text-xs font-display font-bold uppercase tracking-widest shadow-glow-sm mb-5">
                  <Sparkles size={14} /> Exclusive Offer · SK Motors Madurai
                </div>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold uppercase leading-tight">
                  Free <span className="text-primary text-glow">Spare Bike</span> While Yours Is In Service
                </h2>
                <p className="mt-4 text-base md:text-lg text-foreground/90 max-w-2xl leading-relaxed">
                  Drop your bike with us and ride home on a spare — completely free of cost,
                  <span className="text-primary font-bold"> petrol included</span>.
                  Available <span className="text-primary font-bold">only for the first customer to pre-book</span> each day.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/15 border border-primary/40 text-primary text-sm font-bold uppercase tracking-wider"><Gift size={14} /> Zero Cost</span>
                  <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/15 border border-primary/40 text-primary text-sm font-bold uppercase tracking-wider"><Droplets size={14} /> Petrol Included</span>
                ...
                <a
                  href="https://wa.me/919843777729?text=Hi%2C%20I%27d%20like%20to%20pre-book%20the%20free%20spare%20bike%20offer."
                  target="_blank" rel="noopener"
      ...
      {/* FAMILY ADVENTURE PARK / KIDS */}
      <section className="relative py-16 md:py-20 overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <Reveal>
            <div className="grid md:grid-cols-2 gap-8 items-center bg-gradient-to-br from-surface to-surface-elevated border border-primary/30 rounded-3xl p-6 md:p-8 shadow-elevated">
              <div className="rounded-2xl overflow-hidden border-2 border-primary/30 shadow-glow-sm">
                <img src={familyAdventure} alt="SK Motors Family Adventure Park — kids bikes" className="w-full h-auto object-cover" />
              </div>
              <div>
                <span className="text-primary font-bold tracking-widest uppercase text-xs">For The Whole Family</span>
                <h2 className="mt-2 text-3xl md:text-4xl font-display font-bold uppercase leading-tight">
                  Kids <span className="text-primary text-glow">Bikes & Services</span> Available Too
                </h2>
                <p className="mt-3 text-muted-foreground leading-relaxed">
                  We don't just service grown-up rides — kids' bikes and full servicing for them are also available
                  at SK Motors. Bring the whole family to our Family Adventure Park experience: safe, fun and supervised.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-foreground/90">
                  <li className="flex items-center gap-2"><Check size={16} className="text-primary" /> Kids bike sales & service</li>
                  <li className="flex items-center gap-2"><Check size={16} className="text-primary" /> Safety supervised rides</li>
                  <li className="flex items-center gap-2"><Check size={16} className="text-primary" /> Doorstep service available</li>
                </ul>
              </div>
            </div>
          </Reveal>
      ...
      <section id="events" className="relative py-20 md:py-24 bg-surface/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <Reveal>
            <div className="text-center mb-12">
              <span className="text-primary font-bold tracking-widest uppercase text-xs">Stay Informed</span>
              <h2 className="mt-2 text-4xl md:text-5xl font-display font-bold uppercase">Useful Information & Events</h2>
              <p className="mt-3 text-muted-foreground max-w-2xl mx-auto">
                Maintenance know-how, customer events and adventure rides — straight from SK Motors.
              </p>
            </div>
          </Reveal>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { img: infoPmParts, tag: "Useful Info", title: "PM Parts & Vehicle Health", desc: "Why preventive maintenance parts matter for your bike's long life." },
              { img: eventSpinWheel, tag: "Event", title: "Spin The Wheel · Win Prizes", desc: "Visit the workshop and try your luck — exciting prizes for customers." },
              { img: eventJungle, tag: "Event", title: "Jungle Off-Road Ride", desc: "Into the wild adventure — join our group off-road experience." },
              { img: eventDesert, tag: "Event", title: "Desert Thrill Ride", desc: "Ride the sands, feel the power — a thrilling SK Motors event." },
            ].map((c, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="group h-full bg-surface border border-border rounded-2xl overflow-hidden hover:border-primary/60 hover:-translate-y-1 transition-all hover:shadow-glow-sm">
                  ...
                  <div className="p-5">
                    <span className="text-[10px] uppercase tracking-widest text-primary font-bold">{c.tag}</span>
                    <h3 className="mt-1 font-display font-bold text-lg uppercase leading-tight">{c.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-display font-bold">SK MOTORS Service Madurai</span>
            </div>
